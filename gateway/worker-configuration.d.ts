/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=gateway/wrangler.jsonc gateway/worker-configuration.d.ts` (hash: 301c1f3a2e1307968d6d98b4e00a9316)
...
interface __BaseEnv_Env {
	...
	LAB_ORIGIN: "http://localhost:8787";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "LAB_ORIGIN" | "LAB_SERVICE_TOKEN">> {}
}
